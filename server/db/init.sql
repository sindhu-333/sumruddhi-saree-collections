...
ALTER TABLE products ADD COLUMN IF NOT EXISTS offer_price NUMERIC(10,2) DEFAULT 0;
ALTER TABLE products ADD COLUMN IF NOT EXISTS offer_ends_in_days INTEGER DEFAULT 0;
ALTER TABLE products ADD COLUMN IF NOT EXISTS offer_label TEXT DEFAULT '';
